...
M_Complex* FFT::fft1(M_Complex *data, unsigned int size, int log2n,  bool inverse)
{
...
M_Complex** FFT::fft2(M_Complex **data, int r, int c, bool inverse)
{
    M_Complex *row = new M_Complex[r];
    M_Complex *column = new M_Complex[c];
    int log2w = r >> 1;
    int log2h = c >> 1;
